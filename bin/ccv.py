...
_libraries = {}
_libraries['libccv'] = CDLL('/home/me/ccv/lib/libccv.%s' % _get_system_extension())
STRING = c_char_p
WSTRING = c_wchar_p
...
class ccv_letter_t(Structure):
    pass
ccv_letter_t._fields_ = [
    ('rect', ccv_rect_t),
    ('center', ccv_point_t),
    ('thickness', c_int),
    ('intensity', c_int),
    ('std', c_double),
    ('mean', c_double),
    ('contour', POINTER(ccv_contour_t)),
]

class ccv_textline2_t(Structure):
    pass
ccv_textline2_t._fields_ = [
    ('rect', ccv_rect_t),
    ('neighbours', c_int),
    ('letters', POINTER(ccv_array_t)),
]
...
ccv_swt_detect_textlines2 = _libraries['libccv'].ccv_swt_detect_textlines2
ccv_swt_detect_textlines2.restype = POINTER(ccv_array_t)
ccv_swt_detect_textlines2.argtypes = [POINTER(ccv_dense_matrix_t), ccv_swt_param_t]
ccv_swt_free_textlines2 = _libraries['libccv'].ccv_swt_free_textlines2
ccv_swt_free_textlines2.restype = None
ccv_swt_free_textlines2.argtypes = [POINTER(ccv_array_t)]
...
ipp_resize = _libraries['libccv'].ipp_resize
ipp_resize.restype = None
ipp_resize.argtypes = [POINTER(ccv_dense_matrix_t), POINTER(POINTER(ccv_dense_matrix_t))]

ipp_gauss_filter = _libraries['libccv'].ipp_gauss_filter
ipp_gauss_filter.restype = None
ipp_gauss_filter.argtypes = [POINTER(ccv_dense_matrix_t), POINTER(POINTER(ccv_dense_matrix_t))]
